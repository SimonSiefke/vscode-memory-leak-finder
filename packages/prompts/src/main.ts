...
const relativePath = `/home/simon/.cache/repos/vscode-memory-leak-finder/.vscode-memory-leak-finder-results/extension-host/named-function-count3/chat-editor-add-numbers.json`
