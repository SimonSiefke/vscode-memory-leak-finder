...
export const Buffer = 'Buffer.prototype'
export const Canvas = 'HTMLCanvasElement.prototype'
export const CanvasRenderingContext2d = 'CanvasRenderingContext2D.prototype'
...
export const FinalizationRegistry = 'FinalizationRegistry.prototype'
export const Function = 'Function.prototype'
export const GPUCanvasContext = 'GPUCanvasContext.prototype'
export const HtmlElement = 'HTMLElement.prototype'
export const Iframe = 'HTMLIFrameElement.prototype '
export const ImageBitmap = 'ImageBitmap.prototype'
...
export const MessagePort = 'MessagePort.prototype'
...
export const TextDecoder = 'TextDecoder.prototype'
export const TextEncoder = 'TextEncoder.prototype'
export const TrustedTypePolicy = 'TrustedTypePolicy.prototype'
export const Url = 'URL.prototype'
export const WeakMap = 'WeakMap.prototype'
export const WeakRef = 'WeakRef.prototype'
export const WeakSet = 'WeakSet.prototype'
export const Webgl2RenderingContext = 'WebGL2RenderingContext.prototype'
export const Worker = 'Worker.prototype'
