...
import * as MemoryLeakFinderRunCompletion from '../MemoryLeakFinderRunCompletion/MemoryLeakFinderRunCompletion.ts'
...
export const commandMap: Record<string, Dynamic> = {
  ...
  [MemoryLeakWorkerCommandType.MemoryLeakFinderRunCompletion]: MemoryLeakFinderRunCompletion.runCompletion,
