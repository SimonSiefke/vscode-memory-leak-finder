...
export const id = MeasureId.PerformanceMarkCounts
...
export const compare = (beforePath: string, afterPath: string) => PerformanceMarkMeasure.compare(beforePath, afterPath, 'count')
