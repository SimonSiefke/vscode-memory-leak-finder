...
describe('CleanIpcMessages', () => {
  describe('readIntVQL', () => {
    it('should read a single byte integer', () => {
    ...
    it('should read a multi-byte integer', () => {
    ...
    it('should read a larger multi-byte integer', () => {
  ...
  describe('deserialize', () => {
    ...
    it('should deserialize a buffer', () => {
    ...
    it('should deserialize a VSBuffer', () => {
      const data = Buffer.from([0x01, 0x02, 0x03])
      const lengthBytes = Buffer.from([data.length])
  ...
  describe('cleanMessages', () => {
    ...
    it('should pass through messages without uint8array args', () => {
      const messages = [
        {
          channel: 'test',
          timestamp: 123,
    ...
    it('should deserialize uint8array args', () => {
    ...
    it('should handle uint8array with invalid binary data', () => {
      const messages = [
        {
          channel: 'test',
          timestamp: 123,
    ...
    it('should deserialize uint8array result', () => {
      // Create a simple VSCode binary message
      const str = 'result'
      const strBytes = Buffer.from(str, 'utf8')
      const lengthBytes = Buffer.from([strBytes.length])
    ...
    it('should handle buffer type args', () => {
      const messages = [
        {
          channel: 'test',
          timestamp: 123,
    ...
    it('should handle messages without args', () => {
      const messages = [
        {
          channel: 'test',
          timestamp: 123,
    ...
    it('should handle messages with empty args array', () => {
      const messages = [
        {
          channel: 'test',
          timestamp: 123,
    ...
    it('should handle handle-error messages', () => {
      const messages = [
        {
          channel: 'test',
          timestamp: 123,
    ...
    it('should handle handle-request messages with uint8array', () => {
      const str = 'request'
      const strBytes = Buffer.from(str, 'utf8')
      const lengthBytes = Buffer.from([strBytes.length])
      const binary = Buffer.concat([Buffer.from([CleanIpcMessages.DataType.String]), lengthBytes, strBytes])
