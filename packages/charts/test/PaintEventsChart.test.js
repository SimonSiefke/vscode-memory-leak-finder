...
test('getPaintEventsData groups repeated document paints with selector breakdowns', async () => {
  ...
  await writeFile(
    ...
    JSON.stringify({
      paintEvents: {
        events: [
          { durationMs: 1, index: 1, nodeName: '#document', rects: [{ area: 100, height: 10, width: 10, x: 0, y: 0 }], startMs: 0, totalArea: 100 },
          { durationMs: 0.5, index: 2, nodeName: "DIV class='slider'", rects: [{ area: 20, height: 5, width: 4, x: 1, y: 2 }], startMs: 1, totalArea: 20 },
          { durationMs: 2, index: 3, nodeName: '#document', rects: [{ area: 100, height: 10, width: 10, x: 0, y: 0 }], startMs: 10, totalArea: 100 },
          { durationMs: 1.5, index: 4, nodeName: "DIV class='slider'", rects: [{ area: 20, height: 5, width: 4, x: 1, y: 2 }], startMs: 11, totalArea: 20 },
          { durationMs: 4, index: 5, nodeName: '#document', rects: [{ area: 200, height: 10, width: 20, x: 0, y: 0 }], startMs: 20, totalArea: 200 },
          { durationMs: 3, index: 6, nodeName: "SPAN class='slow'", rects: [{ area: 100, height: 10, width: 10, x: 3, y: 4 }], startMs: 21, totalArea: 100 },
        ],
      },
    }),
  )
