...
test('getTestsUnexpectedErrorMessage - handles error with empty codeFrame', () => {
  ...
  expect(result).toContain('at test.js:5:1')
})
...
test('getTestsUnexpectedErrorMessage - handles multiline stack trace', () => {
  ...
  expect(result).toContain('at first.js:1:1')
  expect(result).toContain('at second.js:2:2')
  expect(result).toContain('at third.js:3:3')
