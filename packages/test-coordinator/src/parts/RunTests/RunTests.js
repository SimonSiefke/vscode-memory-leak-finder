...
export const runTests = (root, cwd, filterValue, headlessMode, color, checkLeaks, runs) => {
  return RunTestsWithCallback.runTests(root, cwd, filterValue, headlessMode, color, checkLeaks, runs, callback)
}
