...
export const launchIde = async ({ headlessMode, cwd, ide, vscodePath }) => {
  if (ide === Ide.Cursor) {
  ...
  return LaunchVsCode.launchVsCode({ headlessMode, cwd, vscodeVersion: VscodeVersion.vscodeVersion, vscodePath })
}
