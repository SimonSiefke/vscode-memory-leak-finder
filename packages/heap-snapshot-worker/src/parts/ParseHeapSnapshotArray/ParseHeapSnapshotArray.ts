...
interface ParseHeapSnapshotArrayResult {
 ...
 * @param {number[]} array - The array to store parsed numbers
 ...
 * @returns {ParseHeapSnapshotArrayResult} - The new data index, array index, completion status, and parsing state
