...
describe('getObjectsWithPropertiesInternal', () => {
  ...
  it('should find objects with existing property', () => {
  ...
  it('should find objects with numeric property value', () => {
    const { nodes, edges, strings, meta } = createMockHeapSnapshotData()
  ...
  it('should handle heap snapshot without metadata', () => {
  ...
  it('should handle array type property values', () => {
    const nodes = new Uint32Array([
      // Node 0: object with id 1
      3, 0, 1, 16, 1, 0,
  ...
  it('should handle unknown type property values', () => {
    const nodes = new Uint32Array([
      // Node 0: object with id 1
      3, 0, 1, 16, 1, 0,
