...
export const getArraysByClosureLocationFromHeapSnapshotInternal = (
  ...
  const arrayNodeMap = new Map<number, ArrayObject>() // nodeDataIndex -> array object
  const closureLocationMap = new Map<string, ClosureGroup>() // locationKey -> { arrays: [], totalSize: 0, count: 0 }
