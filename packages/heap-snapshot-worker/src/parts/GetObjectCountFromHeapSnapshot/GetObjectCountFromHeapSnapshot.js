...
import { getObjectCountFromHeapSnapshotInternal } from '../GetObjectCountFromHeapSnapshotInternal/GetObjectCountFromHeapSnapshotInternal.js'
...
export const getObjectCountFromHeapSnapshot = async (path, objectName) => {
  ...
  const count = getObjectCountFromHeapSnapshotInternal(
    nodes,
    strings,
    ITEMS_PER_EDGE,
    typeFieldIndex,
