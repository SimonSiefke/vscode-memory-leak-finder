...
test('getObjectsWithProperties - should handle object properties with numbers', () => {
  const snapshot: Snapshot = {
    ...
    nodes: new Uint32Array([
      ...
      0,
      0,
      0, // id: 1, type: 0 (object), name: 0, edge_count: 0, self_size: 0
      // Node 1: Number property "x"
      2,
      0,
      1,
      0,
      0, // id: 2, type: 0 (number), name: 1, edge_count: 0, self_size: 0
      // Node 2: Number property "y"
      3,
      0,
      2,
      0,
      0, // id: 3, type: 0 (number), name: 2, edge_count: 0, self_size: 0
      // Node 3: Number property "width"
      4,
      0,
      3,
      0,
      0, // id: 4, type: 0 (number), name: 3, edge_count: 0, self_size: 0
      // Node 4: Number property "height"
      5,
      0,
      4,
      0,
      0, // id: 5, type: 0 (number), name: 4, edge_count: 0, self_size: 0
    ]),
    edges: new Uint32Array([
      ...
      0,
      0,
      0, // type: 0 (property), name_or_index: 0, to_node: 5
      // Edge 1: Object -> Number "y" (property edge)
      0,
      1,
      0,
      0, // type: 0 (property), name_or_index: 1, to_node: 10
      // Edge 2: Object -> Number "width" (property edge)
      0,
      2,
      0,
      0, // type: 0 (property), name_or_index: 2, to_node: 15
      // Edge 3: Object -> Number "height" (property edge)
      0,
      3,
      0,
      0, // type: 0 (property), name_or_index: 3, to_node: 20
    ]),
    strings: [
      'x',
      'y',
      'width',
      'height', // Property names
      '200',
      '300',
      '400',
      '500', // Number values
  ...
  const results = getObjectsWithPropertiesInternal(snapshot, 'x', 1)
...
test('getObjectsWithProperties - should handle multiple numeric properties', () => {
  ...
  const results = getObjectsWithPropertiesInternal(snapshot, 'x', 2)
...
test('getObjectsWithProperties - should handle SMI numbers correctly', () => {
  ...
  const results = getObjectsWithPropertiesInternal(snapshot, 'count', 1)
...
test('getObjectsWithProperties - should handle decimal numbers', () => {
  ...
  const results = getObjectsWithPropertiesInternal(snapshot, 'ratio', 1)
...
test('getObjectsWithProperties - should handle mixed property types', () => {
  const snapshot: Snapshot = {
    ...
    nodes: new Uint32Array([
      ...
      2,
      0,
      0, // id: 3, type: 1 (string), name: 2, edge_count: 0, self_size: 0
      // Node 3: Boolean property "active"
      4,
      2,
      3,
      0,
      0, // id: 4, type: 2 (hidden), name: 3, edge_count: 0, self_size: 0
    ]),
    edges: new Uint32Array([
  ...
  const results = getObjectsWithPropertiesInternal(snapshot, 'age', 2)
