...
test.skip('should count arrays with location information from closures', async () => {
  ...
  const mockHeapSnapshot = {
    ...
    nodes: new Uint32Array([
      ...
      1,
      0,
      0, // Closure 1 - type=closure(5), id=0, edge_count=1
      3,
      0,
      1,
      30,
      2,
      0,
      0, // Context 1 - type=object(3), name=''(0), id=1, edge_count=2
      3,
      0,
      2,
      100,
      0,
      0,
      0, // Array 1 - type=object(3), name=Array(0), id=2
      3,
      0,
      3,
      200,
      0,
      0,
      0, // Array 2 - type=object(3), name=Array(0), id=3
      5,
      0,
      4,
      50,
      1,
      0,
      0, // Closure 2 - type=closure(5), id=4, edge_count=1
      3,
      0,
      5,
      30,
      1,
      0,
      0, // Context 2 - type=object(3), name=''(0), id=5, edge_count=1
      3,
      0,
      6,
      150,
      0,
      0,
      0, // Array 3 - type=object(3), name=Array(0), id=6
    ]),
    ...
    edges: new Uint32Array([
      0,
      3,
      7, // Closure 1 -> Context 1 via 'context' edge (type=0=context, name='context'(3), to node 1 = byte offset 7)
      2,
      1,
      14, // Context 1 -> Array 1 via 'myArray' property (type=2=property, name='myArray'(1), to node 2 = byte offset 14)
      2,
      2,
      21, // Context 1 -> Array 2 via 'items' property (type=2=property, name='items'(2), to node 3 = byte offset 21)
      0,
      3,
      35, // Closure 2 -> Context 2 via 'context' edge (type=0=context, name='context'(3), to node 5 = byte offset 35)
      2,
      1,
      42, // Context 2 -> Array 3 via 'myArray' property (type=2=property, name='myArray'(1), to node 6 = byte offset 42)
    ]),
    ...
    locations: new Uint32Array([
      ...
      1,
      10,
      5, // object_index=0 (Closure 1), script_id=1, line=10, column=5
      28,
      2,
      15,
      8, // object_index=4 (Closure 2, 4*7=28), script_id=2, line=15, column=8
    ]),
  }
...
test.skip('should handle arrays without locations (fallback)', async () => {
  ...
  const mockHeapSnapshot = {
    ...
    edges: new Uint32Array([
      1,
      1,
      7, // property edge to Array 1 (byte offset 7)
      1,
      1,
      7, // property edge to Array 1 (duplicate)
      1,
      2,
      14, // property edge to Array 2 (byte offset 14)
    ]),
...
test.skip('should handle arrays without trace_node_id', async () => {
  ...
  const mockHeapSnapshot = {
    ...
    nodes: new Uint32Array([
      ...
      0,
      1,
      0, // Array with trace_node_id=1 (has location)
    ]),
    edges: new Uint32Array([
      2,
      1,
    ...
    locations: new Uint32Array([
      ...
      1,
      10,
      5, // object_index=2 (14/7), script_id=1, line=10, column=5
    ]),
  }
...
test.skip('should group arrays by name and collect unique locations', async () => {
  ...
  const mockHeapSnapshot = {
    ...
    nodes: new Uint32Array([
      ...
      0,
      1,
      0, // Array 4 - trace_node_id=1 (same as first)
    ]),
    edges: new Uint32Array([
      2,
      1,
      7, // myArray -> Array 1 (byte offset 7)
      2,
      1,
      14, // myArray -> Array 2 (byte offset 14)
      2,
      1,
      21, // myArray -> Array 3 (byte offset 21)
      2,
      1,
      28, // myArray -> Array 4 (byte offset 28)
    ]),
    strings: ['Array', 'myArray', 'source'],
    locations: new Uint32Array([
      7,
...
test.skip('should sort results by count descending', async () => {
  ...
  const mockHeapSnapshot = {
    ...
    edges: new Uint32Array([
      ...
      2,
      2,
      28, // items -> Array 4 (byte offset 28)
    ]),
