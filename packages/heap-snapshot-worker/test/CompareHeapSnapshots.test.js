...
test('compareHeapSnapshots - no leaks', () => {
  ...
  const locations1 = new Uint32Array([
    ...
    1, 100, 10, 5,  // Function A: 2 instances
    2, 100, 10, 5,
    3, 200, 20, 15, // Function B: 1 instance
  ])

  const locations2 = new Uint32Array([
    // objectIndex, scriptId, line, column
    4, 100, 10, 5,  // Function A: 2 instances (same)
    5, 100, 10, 5,
    6, 200, 20, 15, // Function B: 1 instance (same)
  ])
...
test('compareHeapSnapshots - function count increased', () => {
  ...
  const locations1 = new Uint32Array([
    // objectIndex, scriptId, line, column
    1, 100, 10, 5,  // Function A: 1 instance
    2, 200, 20, 15, // Function B: 1 instance
  ])

  const locations2 = new Uint32Array([
    // objectIndex, scriptId, line, column
    3, 100, 10, 5,  // Function A: 3 instances (increased by 2)
    4, 100, 10, 5,
    5, 100, 10, 5,
    6, 200, 20, 15, // Function B: 1 instance (same)
  ])
...
test('compareHeapSnapshots - new function appeared', () => {
  ...
  const locations2 = new Uint32Array([
    // objectIndex, scriptId, line, column
    2, 100, 10, 5,  // Function A: 1 instance (same)
    3, 200, 20, 15, // Function B: 2 instances (new)
    4, 200, 20, 15,
  ])
...
test('compareHeapSnapshots - multiple leaks sorted by delta', () => {
  ...
  const locations2 = new Uint32Array([
    // objectIndex, scriptId, line, column
    3, 100, 10, 5,  // Function A: 4 instances (increased by 3)
    4, 100, 10, 5,
    5, 100, 10, 5,
    6, 100, 10, 5,
    7, 200, 20, 15, // Function B: 2 instances (increased by 1)
    8, 200, 20, 15,
    9, 300, 30, 25, // Function C: 1 instance (new)
  ])
...
test('compareHeapSnapshots - function count decreased (not a leak)', () => {
  ...
  const locations1 = new Uint32Array([
    // objectIndex, scriptId, line, column
    1, 100, 10, 5,  // Function A: 3 instances
    2, 100, 10, 5,
    3, 100, 10, 5,
  ])
  ...
  const locations2 = new Uint32Array([
    // objectIndex, scriptId, line, column
    4, 100, 10, 5,  // Function A: 1 instance (decreased by 2)
  ])
