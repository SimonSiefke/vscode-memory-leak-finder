...
test('getMediaQueryListCountFromHeapSnapshot should return correct count for MediaQueryList objects', () => {
  const testData: Snapshot = {
    ...
    extra_native_bytes: 0,
    nodes: new Uint32Array([
      3, 1, 1, 32, 0, 0, 0, // MediaQueryList object
      3, 1, 2, 32, 0, 0, 0, // MediaQueryList object
      3, 1, 3, 32, 0, 0, 0, // MediaQueryList object
      1, 2, 4, 32, 0, 0, 0, // Array object
      3, 1, 5, 32, 0, 0, 0, // MediaQueryList object
      3, 1, 6, 32, 0, 0, 0, // MediaQueryList object
      3, 1, 7, 32, 0, 0, 0, // MediaQueryList object
      2, 3, 8, 32, 0, 0, 0, // String object
    ]),
    edges: new Uint32Array([]),
    locations: new Uint32Array([]),
