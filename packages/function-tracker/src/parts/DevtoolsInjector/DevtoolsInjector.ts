...
export class VSCodeFunctionTracker {
  ...
  async initialize(): Promise<void> {
    ...
    const transformedPath: string =
      '/home/simon/.cache/repos/vscode-memory-leak-finder/packages/function-tracker/workbench.desktop.main.tracked.js'
    ...
    this.browser = await puppeteer.launch({
      headless: false,
      devtools: true,
      args: ['--remote-debugging-port=9222', '--disable-web-security', '--disable-features=VizDisplayCompositor'],
    })
