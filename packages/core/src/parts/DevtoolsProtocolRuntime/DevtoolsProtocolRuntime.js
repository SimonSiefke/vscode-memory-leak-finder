...
export const evaluate = async (session, options) => {
  const rawResult = await session.send(DevtoolsCommandType.RuntimeEvaluate, options)
...
export const callFunctionOn = async (session, options) => {
  const rawResult = await session.send(DevtoolsCommandType.RuntimeCallFunctionOn, options)
  const result = UnwrapDevtoolsEvaluateResult.unwrapResult(rawResult)
  return result
}
...
export const getProperties = async (session, options) => {
  const rawResult = await session.send(DevtoolsCommandType.RuntimeGetProperties, options)
  const result = UnwrapDevtoolsEvaluateResult.unwrapResult(rawResult)
  return result
}
...
export const runIfWaitingForDebugger = async (session) => {
  const rawResult = await session.send(DevtoolsCommandType.RuntimeRunIfWaitingForDebugger)
  UnwrapDevtoolsEvaluateResult.unwrapResult(rawResult)
}
...
export const queryObjects = async (session, options) => {
  const rawResult = await session.send(DevtoolsCommandType.RuntimeQueryObjects, options)
  const result = UnwrapDevtoolsEvaluateResult.unwrapResult(rawResult)
  return result
}
...
export const releaseObjectGroup = async (session, options) => {
  const rawResult = await session.send(DevtoolsCommandType.RuntimeReleaseObjectGroup, options)
  const result = UnwrapDevtoolsEvaluateResult.unwrapResult(rawResult)
  return result
}
