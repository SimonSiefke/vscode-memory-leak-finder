...
import { removePlaywrightListeners } from "../removePlaywrightListeners/removePlaywrightListeners.js";
...
export const start = async (session, objectGroup) => {
  ...
  return RemoveObjectIds.removeObjectIds(removePlaywrightListeners(result));
};
