...
export const dispatchMeasureWorkflow = async (
  ...
  } = await getUserDataDownloadInfo(env)
  await octokit.rest.actions.createWorkflowDispatch({
    ...
    inputs: {
      ...
      download_vscode_mock_requests_zip_file_url: downloadVscodeMockRequestsZipFileUrl,
      download_vscode_proxy_certs_zip_file_url: downloadVscodeProxyCertsZipFileUrl,
      download_vscode_requests_zip_file_url: downloadVscodeRequestsZipFileUrl,
