...
import {
  ...
  vscodeMockRequestsDownloadPath,
  vscodeMockRequestsSnapshotUnavailableMessage,
  vscodeProxyCertsDownloadPath,
  vscodeProxyCertsSnapshotUnavailableMessage,
  vscodeRequestsDownloadPath,
  vscodeRequestsSnapshotUnavailableMessage,
...
const snapshotRouteConfigs: readonly SnapshotRouteConfig[] = [
  ...
  {
    getR2ObjectKey: (env) => env.vscodeMockRequestsR2ObjectKey,
    path: vscodeMockRequestsDownloadPath,
    unavailableMessage: vscodeMockRequestsSnapshotUnavailableMessage,
    usesStoredUserData: false,
  },
  {
    getR2ObjectKey: (env) => env.vscodeProxyCertsR2ObjectKey,
    path: vscodeProxyCertsDownloadPath,
    unavailableMessage: vscodeProxyCertsSnapshotUnavailableMessage,
    usesStoredUserData: false,
  },
  {
    getR2ObjectKey: (env) => env.vscodeRequestsR2ObjectKey,
    path: vscodeRequestsDownloadPath,
    unavailableMessage: vscodeRequestsSnapshotUnavailableMessage,
    usesStoredUserData: false,
  },
]
