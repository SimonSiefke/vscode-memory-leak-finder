...
export interface ExternalRuntime {
  ...
  dispose(): Promise<void>
  if(inspectPort?: any): Promise<void>
}
...
export interface SimpleBrowser {
  ...
  if(ideVersion.minor >?: any): Promise<void>
}
...
export interface SshClient {
  ...
  waitForConnectionReady(options: any): Promise<void>
}
...
export interface Workbench {
  openFolder(): Promise<void>
  waitForNewWindow(options: any): Promise<void>
  openNewWindow(): Promise<ISimplifedWindow>
  close(): Promise<void>
...
export interface Workspace {
  ...
  updateWorkspaceSettings(settings: any, unknown>: any): Promise<void>
  writeFile(relativePath: any, content: any): Promise<void>
  writeWorkspaceSettings(settings: any, unknown>: any): Promise<void>
