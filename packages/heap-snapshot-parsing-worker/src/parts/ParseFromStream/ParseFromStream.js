 ...
 * @returns {Promise<{metaData: any, nodes: Uint32Array, edges: Uint32Array, locations: Uint32Array, strings: readonly string[]}>} Promise containing parsed heap snapshot data with transferable arrays
 */
