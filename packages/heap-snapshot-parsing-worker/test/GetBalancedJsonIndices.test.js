...
test('getBalancedJsonIndices - handles object with numeric values', () => {
  const data = '{"key1":123,"key2":"value"}'
  const result = getBalancedJsonIndices(data, 0)

  expect(result).toBe(data.length)
})

test('getBalancedJsonIndices - handles object with boolean values', () => {
