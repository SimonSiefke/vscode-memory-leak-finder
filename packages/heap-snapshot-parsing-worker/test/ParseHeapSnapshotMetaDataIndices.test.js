...
test('parseHeapSnapshotMetaDataIndices - handles data with prefix', () => {
  const data =
    'prefix{"snapshot":{"meta":{"node_fields":["type","name","id"],"node_types":[["hidden","array","string","object"]],"edge_fields":["type","name_or_index","to_node"],"edge_types":[["context","element","property","internal"]],"location_fields":["object_index","script_id","line","column"]},"node_count":1,"edge_count":0}}'
...
test('parseHeapSnapshotMetaDataIndices - handles data with suffix', () => {
  const data =
    '{"snapshot":{"meta":{"node_fields":["type","name","id"],"node_types":[["hidden","array","string","object"]],"edge_fields":["type","name_or_index","to_node"],"edge_types":[["context","element","property","internal"]],"location_fields":["object_index","script_id","line","column"]},"node_count":1,"edge_count":0}}suffix'
...
test('parseHeapSnapshotMetaDataIndices - handles snapshot with quoted strings containing brackets', () => {
  const data =
    '{"snapshot":{"meta":{"node_fields":["type","name","id"],"node_types":[["hidden","array","string","object"]],"edge_fields":["type","name_or_index","to_node"],"edge_types":[["context","element","property","internal"]],"location_fields":["object_index","script_id","line","column"]},"node_count":1,"edge_count":0,"description":"Test with {brackets} and [arrays]"}}'
...
test('parseHeapSnapshotMetaDataIndices - handles snapshot with escaped quotes', () => {
  const data =
    '{"snapshot":{"meta":{"node_fields":["type","name","id"],"node_types":[["hidden","array","string","object"]],"edge_fields":["type","name_or_index","to_node"],"edge_types":[["context","element","property","internal"]],"location_fields":["object_index","script_id","line","column"]},"node_count":1,"edge_count":0,"description":"Test with \\"quotes\\""}}'
