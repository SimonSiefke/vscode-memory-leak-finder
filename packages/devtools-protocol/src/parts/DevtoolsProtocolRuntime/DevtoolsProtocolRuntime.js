...
/**
 *
 * @param {{objectId: string, ownProperties?:boolean, generatePreview?:boolean, accessorPropertiesOnly?:boolean, nonIndexedPropertiesOnly?: boolean,objectGroup?:string }} options
 * @returns
 */
