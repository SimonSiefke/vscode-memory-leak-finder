...
test('resolveCommitHash - resolves branch name to commit hash', async () => {
  ...
  expect(mockExeca).toHaveBeenCalledWith('git', ['ls-remote', 'https://github.com/test/repo.git', 'main'])
})
...
test('resolveCommitHash - throws error when no commit found', async () => {
  ...
  expect(mockExeca).toHaveBeenCalledTimes(1)
  expect(mockExeca).toHaveBeenCalledWith('git', ['ls-remote', 'https://github.com/test/repo.git', 'nonexistent-branch'])
})
...
test('resolveCommitHash - resolves tag to commit hash', async () => {
  ...
  expect(mockExeca).toHaveBeenCalledTimes(1)
  expect(mockExeca).toHaveBeenCalledWith('git', ['ls-remote', 'https://github.com/test/repo.git', 'v1.0.0'])
})
...
test('resolveCommitHash - handles different repository URLs', async () => {
  ...
  expect(mockExeca).toHaveBeenCalledTimes(1)
  expect(mockExeca).toHaveBeenCalledWith('git', ['ls-remote', 'https://gitlab.com/test/repo.git', 'feature'])
})
