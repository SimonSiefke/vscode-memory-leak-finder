...
export const getStorageFolders = () => {
  ...
  const globalStoragePath = process.env.GLOBAL_STORAGE || join(userDataPath, 'User', 'globalStorage')
  const workSpaceStoragePaths = process.env.WORKSPACE_STORAGE || join(userDataPath, 'User', 'workspaceStorage')
  return {
    globalStoragePath,
