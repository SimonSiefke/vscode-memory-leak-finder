...
function updateDependencies {
  ...
  OUTPUT=`ncu -u -x @types/node -x jest -x @jest/globals -x rollup -x typescript -x lerna -x jsdom -x babel/core -x @babel/preset-typescript -x @babel/parser -x @babel/core -x @babel/code-frame -x @babel/generator -x @babel/traverse -x @babel/types`
